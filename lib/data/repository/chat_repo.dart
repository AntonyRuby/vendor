...
class ChatRepo {
  ...
  Future<Response> getConversationList(int offset) async {
    return await apiClient.getData(
        '${AppConstants.GET_CONVERSATION_LIST}?offset=$offset&limit=10');
  }
  ...
  Future<Response> getMessages(
    ...
    return await apiClient.getData(
        '${AppConstants.GET_MESSAGE_LIST_URI}?offset=$offset&limit=10&${conversationID != null ? 'conversation_id' : userType == UserType.delivery_man ? 'delivery_man_id' : 'user_id'}=${conversationID ?? userId}');
  }
    ...
    return await apiClient.postMultipartData(
      AppConstants.SEND_MESSAGE_URI,
      {
        ...
        '${conversationId != null ? 'conversation_id' : 'receiver_id'}':
            '${conversationId != null ? conversationId : userId}',
        'offset': '1',
        'limit': '10'
      },
      images,
