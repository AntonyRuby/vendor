          ...
          child: Column(children: [
            ...
            SizedBox(
                height: (_conversation.conversations != null &&
                    ...
                    : 0),
            Expanded(
              child: (_conversation.conversations != null)
                  ? (_conversation.conversations?.length ?? 0) > 0
                      ? RefreshIndicator(
                          onRefresh: () async {
                            Get.find<ChatController>().getConversationList(1);
                          },
                                          ...
                                          child: PaginatedListView(
                                            ...
                                            onPaginate: (int offset) =>
                                                chatController
                                                    .getConversationList(
                                                        offset),
                                            totalSize:
                                                _conversation.totalSize ?? 0,
                                            offset: _conversation.offset ?? 0,
                                            ...
                                            productView: ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                print(
                                                    'image issue: $_baseUrl/${_user != null ? _user.image : ''}');
