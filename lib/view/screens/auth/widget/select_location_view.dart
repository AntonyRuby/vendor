...
class SelectLocationView extends StatefulWidget {
  ...
  const SelectLocationView(
      {required this.fromView, required this.mapController});
...
class _SelectLocationViewState extends State<SelectLocationView> {
  ...
  late GoogleMapController _screenMapController;
            ...
            child:
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      child:
                        ...
                        return Text(
                          authController.pickAddress.isEmpty
                              ? 'search'.tr
                              : authController.pickAddress,
              ...
              authController.zoneList.length > 0
                  ? Row(children: [
                      ...
                      Expanded(
                        ...
                        controller: TextEditingController(
                          text: authController.restaurantLocation != null
                              ? authController.restaurantLocation.longitude
                                  .toString()
                              : '',
                        ),
                        isEnabled: false,
              ...
              Center(
                child: Text(
                  ...
                  style:
                      robotoBold.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
                ),
              ),
              ...
              authController.zoneIds != null
                  ? Container(
                      ...
                      child: DropdownButton<int>(
                        ...
                        onChanged: (value) {
                          authController.setZoneIndex(value ?? 0);
                        },
                        isExpanded: true,
                        underline: SizedBox(),
                      ),
